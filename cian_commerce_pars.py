...
while True:
    ...
    with webdriver.Chrome(service=Service(ChromeDriverManager().install()),
        ...
        driver.get(
            f"https://cian.ru/cat.php?deal_type={tema}&engine_version=2&offer_type=offices&office_type%5B0%5D={vidned}&p=2&region={city}")  # Открываем страницу
    ...
    for url in urls:
        ...
        zapros = (url.find_next('a').get('href'))
